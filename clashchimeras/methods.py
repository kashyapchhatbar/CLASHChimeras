...
def chimeraOrNot(bitOne, bitTwo, overlap=4, gap=9):
  ...
  for i, j in zip(bitOne, bitTwo):
    if i == "M" and j == "M": combinedCigar += "="
    elif i == "S" and j == "S": combinedCigar += "#"
    elif i == "I" and j == "D": combinedCigar += "-"
    elif i == "D" and j == "I": combinedCigar += "-"
    elif i == "M" and j != "M": combinedCigar += "{"
    elif i != "M" and j == "M": combinedCigar += "}"
    elif i != "M" and j == "D": combinedCigar += "-"
    elif i == "D" and j != "M": combinedCigar += "-"
    elif i == "I" and j != "M": combinedCigar += "+"
    elif i != "M" and j == "I": combinedCigar += "+"
    else: combinedCigar += "*"
